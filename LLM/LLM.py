...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "- Never call web_company_lookup a second time for the same company in "
    "the same task -- not even after the user supplies a missing field "
    "manually. One lookup result is final; treat anything it marked 'not "
    "found' as staying not found unless the user gives it to you directly.\n"
    ...
    "- Call erp_data_tool with operation='create' using that data. If it "
