...
GENERAL_ERP_PROMPT = (
    ...
    "  4. Only after this exhaustive hunt, present the fully enriched proposal to the user for confirmation. CRITICAL: When proposing the Lead, you MUST proactively ask the user about the Lead's specific requirements (e.g. 'What specific products, services, or manufacturing specifications are they looking for?') so you can capture their needs immediately. Then create the lead once confirmed.\n\n"
