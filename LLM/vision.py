...
class VisionMixin:
    """
    Mixin class providing multi-format OCR vision extraction (PDF + Image support)
    and general-purpose document reading using OpenAI Vision API.
    Expects self.base_url, self.headers, and self.model_name to be set.
    """
