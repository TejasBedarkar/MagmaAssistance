...
from .DashboardUI_tools import (
    DASHBOARD_UI_TOOLS,
    REQUIRED_FIELDS as DASHBOARD_REQUIRED_FIELDS,
    FIELD_PARSERS as DASHBOARD_FIELD_PARSERS,
)
from .manufacturing_bom_write_tools import (
    MANUFACTURING_BOM_WRITE_TOOLS,
    REQUIRED_FIELDS as MANUFACTURING_BOM_REQUIRED_FIELDS,
    FIELD_PARSERS as MANUFACTURING_BOM_FIELD_PARSERS,
)
from .manufacturing_reports_tools import (
    MANUFACTURING_REPORTS_TOOLS,
    REQUIRED_FIELDS as MANUFACTURING_REPORTS_REQUIRED_FIELDS,
    FIELD_PARSERS as MANUFACTURING_REPORTS_FIELD_PARSERS,
)
...
ALL_REQUIRED_FIELDS = {
    ...
    **MANUFACTURING_BOM_REQUIRED_FIELDS,
    **MANUFACTURING_REPORTS_REQUIRED_FIELDS,
}
...
ALL_FIELD_PARSERS = {
    ...
    **DASHBOARD_FIELD_PARSERS,
    **MANUFACTURING_BOM_FIELD_PARSERS,
    **MANUFACTURING_REPORTS_FIELD_PARSERS,
}
