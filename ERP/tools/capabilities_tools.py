...
DOMAIN_PATTERNS = [
    ...
    ("Item Lead Times", ("item_lead_time",)),
    ("Master Production Schedules", ("production_schedule",)),
    ("Downtime Entries", ("downtime_entry",)),
    ("Sales Forecasts", ("sales_forecast",)),
    ("Bills of Materials", ("_bom", "create_bom", "update_bom")),
